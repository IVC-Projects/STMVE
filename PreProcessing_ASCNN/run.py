...
torch.cuda.device(2) # change this if you have a multiple graphics cards and you want to utilize them
...
arguments_strFirst = './images/b1.png'
arguments_strSecond = './images/b4.png'
arguments_strOut = './b2.png'
