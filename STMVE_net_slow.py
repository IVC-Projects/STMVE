...
def network(frame1, frame2, frame3, reuse = False, scope='netflow'):
    ...
    with tf.variable_scope(scope, reuse=reuse):
        with slim.arg_scope([slim.conv2d], activation_fn=tflearn.activations.relu,
            ...
            #feature merging
            concat12_1x1 = slim.conv2d(concat1_12, 64, [3, 3], scope='concat12_1x1')
            c21 = slim.conv2d(concat12_1x1, 64, [3, 3], scope='conv2_1')
            concat23_1x1 = slim.conv2d(concat1_23, 64, [3, 3], scope='concat23_1x1')
            ...
            # rename!
            conv = slim.conv2d(concat3_12, 64, [3, 3], scope='conv')
