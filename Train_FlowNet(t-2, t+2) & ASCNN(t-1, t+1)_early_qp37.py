...
from FlowNet(t-2, t+2) & ASCNN(t-1, t+1)_early_qp37_network import network
from UTIL_FlowNet(t-2, t+2) & ASCNN(t-1, t+1)_early_qp37 import *

tf.logging.set_verbosity(tf.logging.WARN)
#os.environ["CUDA_VISIBLE_DEVICES"] = "1"

EXP_DATA = 'FlowNet(t-2, t+2) & ASCNN(t-1, t+1)_early_qp37'

LOW_DATA_PATH = r"E:\MF\MF_ASCNN\trainingSet\qp37\low_data"
HIGH1_DATA_PATH = r"E:\MF\trainSet\qp37\FlowNet_out1"
HIGH2_DATA_PATH = r"E:\MF\trainSet\qp37\FlowNet_out2"
# ASCNN-preprocessing
HIGH3_DATA_PATH = r"E:\MF\MF_ASCNN\trainingSet\qp37\ASCNN_13"
...
# model_path = r'E:\MF\MF_ASCNN\MF_FlowNet_ASCNN_project\checkpoints\MF_qp32_ra_04072_ResNet__AS13_Flow04_slowFusion\MF_qp32_ra_04072_ResNet__AS13_Flow04_slowFusion_032.ckpt'
...
if __name__ == '__main__':
    ...
    train_list = get_train_list(load_file_list(HIGH1_DATA_PATH), load_file_list(LOW_DATA_PATH),
                                load_file_list(HIGH2_DATA_PATH), load_file_list(HIGH3_DATA_PATH),
                                load_file_list(LABEL_PATH))
    ...
    with tf.name_scope('input_scope'):
        ...
        train_hight3Data = tf.placeholder('float32', shape=(BATCH_SIZE, PATCH_SIZE[0], PATCH_SIZE[1], 1))
    ...
    train_output = shared_model(train_hight1Data, train_lowData, train_hight2Data, train_hight3Data)
    ...
    with tf.Session(config=config) as sess:
        ...
        for epoch in range(MAX_EPOCH):
            ...
            for idx in range(1000):
                # idx = idxOfImgs[idx]
                input_high1Data, input_lowData, input_high2Data, input_high3Data, gt_data = prepare_nn_data(train_list)
                feed_dict = {train_hight1Data: input_high1Data, train_lowData: input_lowData,
                             train_hight2Data: input_high2Data, train_hight3Data: input_high3Data, train_gt: gt_data}
